...
lower_green = np.uint8(np.array([130, 128, 120]))
upper_green = np.uint8(np.array([161, 159, 151]))
...
background = cv2.imread('C:/Users/Adam.Ramlan/Desktop/chroma-key-javascript-master/background.jpg', cv2.IMREAD_COLOR)
